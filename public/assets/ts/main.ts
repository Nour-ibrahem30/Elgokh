...
import { firebaseConfig, Testimonial } from './firebase-config';

// Three.js and GSAP are loaded from CDN as global variables
...
const navbarToggle = document.querySelector('.navbar-toggle') as HTMLButtonElement;
