 ...
 * يقوم بإرسال جميع البيانات التجريبية إلى Firebase
 */
...
// بيانات المستخدمين التجريبية (استخدام UIDs الحقيقية من Firebase Auth)
const sampleUsers = [
  {
    uid: 'UE1we4psryQOpB9Wyd4pKgC5K1g1', // المدرس
  ...
  {
    uid: 'ktFIQ0dE3WP22vv5bkBlidmSsvj1', // الطالب 1
  ...
  {
    uid: 'mDRljNUbbHeNZaTfqf0Xn1KP5Ue2', // الطالب 2
  ...
  {
    uid: 'cRzpji3Ry9Pk4Up3slumz2w1SR52', // الطالب 3
...
const sampleTodos = [
  {
    userId: 'ktFIQ0dE3WP22vv5bkBlidmSsvj1', // الطالب 1
  ...
  {
    userId: 'mDRljNUbbHeNZaTfqf0Xn1KP5Ue2', // الطالب 2
...
const sampleExamResults = [
  {
    ...
    studentId: 'ktFIQ0dE3WP22vv5bkBlidmSsvj1', // الطالب 1
    answers: [0, false, 2],
    score: 12,
    totalQuestions: 3,
  ...
  {
    examId: 'exam-math-001',
    studentId: 'mDRljNUbbHeNZaTfqf0Xn1KP5Ue2', // الطالب 2
    answers: [1, true, 0],
    score: 3,
    totalQuestions: 3,
...
async function seedDatabase() {
  try {
    ...
    console.log('\n👨‍🎓 الطلاب:');
    sampleUsers.filter(u => u.role === 'student').forEach((student, index) => {
      console.log(`   الطالب ${index + 1}:`);
