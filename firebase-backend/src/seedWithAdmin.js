/**
 * Firebase Database Seeder using Admin SDK
 * يقوم بإرسال جميع البيانات التجريبية إلى Firebase باستخدام Admin SDK
 */
...
console.log('🚀 بدء إعداد Firebase Admin SDK...\n');

// تهيئة Firebase Admin SDK
try {
  // يمكنك إما استخدام ملف مفتاح الخدمة أو متغيرات البيئة
  // للتبسيط، سنستخدم إعدادات افتراضية
...
// دالة إرسال البيانات باستخدام Admin SDK
async function seedDatabase() {
  try {
    ...
    for (const progress of sampleProgress) {
      ...
      await db.collection('progress').doc(progressId).set(progress);
    }
